                                ...
                                <table class="table table-hover" >
                                    ...
                                    foreach ($order as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo base_url(); ?>index.php/Order_controller/redue_order_by_order/<?php echo $row['order_dt_id']; ?>/<?php echo $row['order_hd_id']; ?>/<?php echo $row['product_id']; ?>/out">-</a>
                                                <?php echo $row['chef_unit']; ?>
                                                <a href="<?php echo base_url(); ?>index.php/Order_controller/add_order_by_order/<?php echo $row['order_dt_id']; ?>/<?php echo $order[0]['order_hd_id']; ?>/<?php echo $row['product_id']; ?>/out">+</a>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a data-hrefdata-delete="index.php/Order_controller/delete_billdetail/<?php echo $row['order_dt_id']; ?>/<?php echo $order[0]['order_hd_id']; ?>/out"   data-toggle="modal" data-target="#confirm-Cancel"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
                                            </td>
                                        </tr>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td class="text-right" colspan="6">
                                                <font color="red">
                                                ***กรุณาพิมพ์ใบเสร็จ 2 ใบ เพื่อใช้ประกอบในการจัดส่งอาหาร<br>
                                                1.ใบที่ 1 เก็บไว้ที่ร้านสำหรับตรวจสอบจำนวนเงินค่าอาหาร<br>
                                                2.ใบที่ 2 ไว้สำหรับจัดส่งอาหาร
                                                </font>
                                            </td>

                                        </tr>
                                        <tr>
                                            <?php if ($order[0]['order_hd_money'] <= 0) { ?>
                                                <td colspan="3">
                                                    <a id="comfirm" href="<?php echo base_url(); ?>index.php/OrderOut_controller/check_biil_out">
                                                ...
                                                <td colspan="2">
                                                    <a  data-toggle="modal" data-target="#confirm-Comfirm-Send" >
                                                        <span class="btn-menu-red">
                                                            <h4>คอนเฟิร์มจัดส่ง</h4>
                                                        </span>
                                                    </a>
                                                </td>
                                            <?php } else { ?>
                                                ...
                                                <td>
                                                <a  id="comfirm" href="<?php echo base_url(); ?>index.php/OrderOut_controller/print_bill_out/<?php echo $order[0]['order_hd_id']; ?>" target="_blank">
                                            ...
                                            <td>
                                                <a href="<?php echo base_url(); ?>index.php/OrderOut_controller/payment_out_view/<?php echo $order[0]['order_hd_id']; ?>/<?php echo $sumPriceAllatVat; ?>/<?php echo $order[0]['order_hd_table_id']; ?>/out">
...
<!-- Modal Cancel -->
<div class="modal fade" id="confirm-Comfirm-Send" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <div class="modal-body">
                <form action="<?php echo base_url(); ?>index.php/OrderOut_controller/update_money/<?php echo $order[0]['order_hd_id']; ?>" method="post" id="form_money">
                    <input type="number" maxlength="10" name="order_hd_money" id="order_hd_money" class="form-control" placeholder="เงินสำหรับใช้ทอน">
                </form>
            </div>
            <div class="modal-footer">
                <button class="btn btn-danger ok-money">ตกลง</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">ยกเลิก</button>
            </div>
        </div>
    </div>
