                                    ...
                                    <?php } ?>
                                        <tr>
                                            <td class="text-right" colspan="4">
                                                <font color="red">***กรุณาพิมพ์ใบสั่งอาหาร ส่งแผนกครัวเพื่อเตรียมปรุงอาหาร</font>
                                            </td>
                                        </tr>
                                </table>  
                                <hr>
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered">
                                        <tr>
                                            ...
                                            <td>
                                                <a id="comfirm" href="<?php echo base_url(); ?>index.php/OrderOut_controller/print_bill_order/<?php echo $order[0]['order_hd_id']; ?>" target="_blank">
